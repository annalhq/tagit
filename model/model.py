...
# IMPORTING DATASET
tsv_file='data/train.tsv' #tab separated values file
...
# Tags columns is a string. so  converted it to a list.
import ast
...
def getTags(question):
	...
	tags = multilabel.inverse_transform(Model.predict(question))
	print(tags)
